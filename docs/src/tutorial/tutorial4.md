...
Here, $\xi_0 \in \mathbb{R}$ represents the return of a benchmark portfolio, while $\xi \in \mathbb{R}^{d}$ denotes the asset returns. The formulation considers $d$ assets and $n$ scenarios. 
